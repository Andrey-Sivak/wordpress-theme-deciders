...
<div class="info-block-inner-block service-filter mb-3" id="service-filter">
    ...
    <ul
        class="service-grid flex gap-x-6 gap-y-3.5 flex-wrap transition-all duration-300"
        id="service-grid"
    >
        <li class="service-item" data-service-id="all" style="order: 1">
        ...
        foreach ($ds_services as $ds_service) :
            ...
            ?>
            <li class="service-item" data-service-id="<?php echo esc_attr($ds_service->ID); ?>" style="order: <?php echo $ds_order; ?>">
                <button
