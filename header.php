...
<div class="ds-mobile-to-top hide fixed md:hidden block top-auto bottom-3 left-auto right-3 bg-deciders-dark py-2 px-3 rounded-[16px] transition-all duration-500 z-30 border border-white/20">Вверх</div>